...
public class MainPersonActivity extends FragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		context = MainPersonActivity.this;
	...
	public void onItemClick(AdapterView<?> arg0, View view, int pos, long arg3) {
		...
		if (type == 0) {
			...
			if (Conf.VIP) {
				Intent intent = new Intent(context, MainViewPageActivity.class);
