 ...
 * 
 */
public class MyImgScroll extends ChildViewPager {
	...
	public void start(Activity mainActivity, List<View> imgList,
		...
		setOvalLayout(ovalLayoutId, ovalLayoutItemId, focusedId, normalId);
	...
	// 设置圆点
	private void setOvalLayout(int ovalLayoutId, final int ovalLayoutItemId,
	...
	private class MyPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View v, int i) {
			...
			try {
				...
				// if (((MyViewPager) v).getChildCount() == mListViews.size()) {
				((ViewPager) v)
