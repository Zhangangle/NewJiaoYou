...
public class BitmapUtils {
	...
	private static final String PICTURE_CAMERA_FILE = "zsd_picture_icon.jpg";
	private static final String PICTURE_CROP_FILE = "sd_picture_crop.jpg";
	public static File iconFile = new File(IOUtils.getApplicationFolder(),
			"icon");

	public static File getPicPath(String name) {
		return new File(IOUtils.getApplicationFolder(), name);
	}

	// private static final String PICTURE_
	// private static final String CAMERA_FOLDER_PATH = Environment
	// .getExternalStorageDirectory() + "/zmv/icon";
	...
	public static void initPictureFile() {
		try {
			pictureFile = new File(IOUtils.getApplicationFolder(),
					PICTURE_CAMERA_FILE);
			if (pictureFile.exists()) {
				pictureFile.delete();
				pictureFile.createNewFile();
			}
			targetPictureFile = new File(IOUtils.getApplicationFolder(),
					PICTURE_CROP_FILE);
	...
	public static Bitmap getCompressImage(File iconFile, float requestWidth,
			float requestHeight) {
		Bitmap bitmap = null;
		if (iconFile.exists()) {
